...
public abstract class GrokParserFactory {
	...
	private static enum GrokPattern {
		STRING,
		INTEGER,
		MONTH,TIMESTAMP_ISO8601,DATE,TIMESTAMP,FIREWALLTIMPESTAMP,DAY,MONTH_INT,YEAR,TIMEZONE,TIMEOFFSET,HOURS,MINUTES,SECONDS,MILLISECONDS
	}
